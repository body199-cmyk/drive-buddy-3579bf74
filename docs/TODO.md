...
| M15-T02 | إصلاح استيراد حزمة Colab: قبول غلاف `teledrive-package.zip` تلقائيًا في Cell 1 | ACTIVE — بانتظار CI | PHASE_17 · 16 اختبار wrapper في `tests/test_restore_package.py` · `322 passed` محليًا |
