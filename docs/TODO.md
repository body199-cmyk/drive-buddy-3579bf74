...
| M17-T02-REST | بقية أولويات M17-T02 الأصلية: Dashboard (P2) · Logs (P4) · Settings (P5) · Export/Recovery (P6) · Transfers live-proof (P3) | PLANNED — بانتظار موافقة Brain | نطاق T02 حُدِّد Drive-فقط برسالة Brain الأخيرة؛ KNOWN_ISSUES #28–#31 ما زالت مفتوحة جزئيًا |
| M17-T03 | إعادة بناء Gradio بصريًا ووظيفيًا (rail/status bar/ثيمات فعلية/empty states) | PLANNED — بعد T02 | شروط M17 §4: ui.py layout only + contract tests للـCSS classes |
| M17-T04 | React اختياري (ADR + bridge + parity gate) — منفصل عن T02 | PLANNED — بعد T01–T03 + Colab live proof | ممنوع قبل parity؛ يحتاج ADR مستقلًا |
