...
| M17-T02 | إصلاح كل action حسب أولويات M17 (Drive → Dashboard → Transfers-proof → Logs → Settings → Export/Recovery) | PLANNED — بانتظار موافقة Brain على جرد T01 | العوائق موثقة في `KNOWN_ISSUES #28–#31` وفي عمودي `current_blocker`/`recommended_fix` بالـinventory |
