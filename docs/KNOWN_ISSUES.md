...
| 10 | **`launcher --check` يحل 22 إجراءً من 41 فقط** — 19 إجراءً غير جاهز، وحالتها (ميت/غير مطبَّق/غير مختبَر) غير مصنَّفة | مخرجات الجلسة الحالية والسابقة | **مفتوحة** — M13-T02، §14 |
| 11 | **pytest لم يُشغَّل في جلسة PR#3** — البوابات المسجَّلة كانت compileall + launcher + notebook + cmp فقط | `docs/AI_HANDOFF.md` قائمة البوابات | ✅ أُغلقت في M12-T01 — pytest شُغِّل فعلًا بمثبتات `requirements.lock`: **299 passed** محليًا وفي CI (run 31243523514) |
